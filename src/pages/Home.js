  ...
  return (
    <div>
      ...
      <div className="banner">
        <div class="bannerTxt">
          <h1>
            Unlock the Door to Your Dream Home: Discover the Ultimate{" "}
            <span>Real Estate</span> Experience
          </h1>
          <h4>
            From cozy blocks of flat to luxurious estates, we're here to make
      ...
      <div className="homeRow1 flex">
        ...
        <div className="featured">
          ...
          >
            <SwiperSlide className="single-pHome">
